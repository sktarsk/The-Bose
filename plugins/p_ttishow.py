...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/TeamLeech')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='https://t.me/TeamLeech') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ DEV Channel ↭  🔥', url='https://t.me/TeamLeech') ]
                                                                                    ] )
                )
